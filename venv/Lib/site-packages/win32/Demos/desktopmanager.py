...
def get_new_desktop_name(parent_hwnd):
    ...
    h = win32gui.CreateDialogIndirect(
        ...
        [['One ugly dialog box !', (100, 100, 200, 100), style, 0],
         ['Button', 'Create', win32con.IDOK, (10, 10, 30, 20),
          win32con.WS_VISIBLE | win32con.WS_TABSTOP | win32con.BS_HOLLOW | win32con.BS_DEFPUSHBUTTON],
...
def create_desktop(desktop_name, start_explorer=1):
    ...
    if start_explorer:
        ...
        prc_info = win32process.CreateProcess(None, "Explorer.exe", None, None, True, win32con.CREATE_NEW_CONSOLE, None,
                                              'c:\\', s)
