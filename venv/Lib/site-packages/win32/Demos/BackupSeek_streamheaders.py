...
ps = pss.Create(pythoncom.FMTID_SummaryInformation, pythoncom.IID_IPropertyStorage, 0,
...
def parse_stream_header(h, ctxt, data):
    ...
    print('\nType:', stream_type, stream_types[stream_type], 'Attributes:', stream_attributes, 'Size:', stream_size,
          'Name len:', stream_name_size)
...
while 1:
    bytes_read, win32_stream_id_buf, ctxt = win32file.BackupRead(h, win32_stream_id_size, win32_stream_id_buf, False,
                                                                 True, ctxt)
    if bytes_read == 0:
        break
